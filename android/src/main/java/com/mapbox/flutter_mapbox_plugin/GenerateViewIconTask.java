...
import static com.mapbox.flutter_mapbox_plugin.MapboxMapController.PROPERTY_CAPITAL;
import static com.mapbox.flutter_mapbox_plugin.MapboxMapController.PROPERTY_NAME;
            ...
            if (activity != null) {
                ...
                for (Feature feature : featureCollection.features()) {
                    ...
                    descriptionTextView.setText(
                            String.format("Capital: %1$s", style));
